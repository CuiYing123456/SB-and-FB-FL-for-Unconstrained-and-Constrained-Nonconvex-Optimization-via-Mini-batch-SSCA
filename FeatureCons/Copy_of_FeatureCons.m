...
T=1000;
B_list = [10, 100, 1000];
a1_list = [0.7, 0.9, 0.3];  a2_list = [0.4, 0.5, 0.3];  alpha_list = [0.2, 0.1, 0.1];  tau_list = [0.1, 0.2, 0.05];
...
for i = 2 : 2      % !!!!!!!!!!
    ...
    for iter=1:L
        ...
        save(sprintf('./SaveData/FCa1_B%d.mat', B), 'a_mean1');
        save(sprintf('./SaveData/FCc1_B%d.mat', B), 'c_mean1');
