...
mon_list = [0.4, 0.5, 0.6, 0.7, 0.8, 0.9];  % [0.1, 0.2, 0.3] --> opt: [0.3, 0.1, 0.3]-->[0.3, 0.7, 0.5]
for i = 1 : length(B_list)
    ...
    for j = 1 : length(lr_list)
        ...
        for k = 1 : length(mon_list)
            ...
            save(sprintf('./SaveData/FUa3_B%d_lr%0.1f_mom%0.1f.mat', B, lr, mom), 'a_end3');
            save(sprintf('./SaveData/FUc3_B%d_lr%0.1f_mom%0.1f.mat', B, lr, mom), 'c_end3');
        end
    end
end
