...
%                 pred = pred';
        ...
        save(sprintf('./SaveData/SUa4_B%d_E%d_lr%0.1f.mat', B, E, lr), 'a_end4');
        save(sprintf('./SaveData/SUc4_B%d_E%d_lr%0.1f.mat', B, E, lr), 'c_end4');
        save(sprintf('./SaveData/SUt4_B%d_E%d_lr%0.1f.mat', B, E, lr), 'time4');
    end
end
