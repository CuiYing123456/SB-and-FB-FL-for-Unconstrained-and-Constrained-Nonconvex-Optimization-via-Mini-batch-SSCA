...
T=1000;
B_list = [50];
a1_list = [0.3, 0.5, 0.8];  % [0.3, 0.7]--> opt: [0.3, 0.7, 0.7]
a2_list = [0.3, 0.5, 0.8];  % [0.3, 0.7]--> opt: [0.3, 0.7, 0.7]-->[0.2(OK!), 0.7, 0.7]
alpha_list = [0.1, 0.3, 0.5];  % [0.3, 0.7] --> opt: [0.3, 0.3, 0.3]-->[0.4(OK!), 0.3, 0.3]
...
%                         J_step1(t,iter)=J;    %������cost function��¼
                        ...
                        if mod(t, 200) == 1
                            ...
                            accur1(ceil(t/200),iter)=mean(double(pred == lab_test)) * 100;
...
%                 save(sprintf('./SaveData/SUc1_B%d_a1%0.1f_a2%0.1f_alpha%0.1f_tau%0.2f.mat', B, a1, a2, alpha, tau), 'c_end1');
