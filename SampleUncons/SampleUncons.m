...
B_list = [5, 10, 50, 100];
E_list = [2, 1, 2, 1];
a1_list = [0, 0.9, 0, 0.3];  a2_list = [0, 0.5, 0, 0.3];  alpha_list = [0, 0.1, 0, 0.1];  tau_list = [0, 0.2, 0, 0.05];
lr_init_SGD_list = [0.3, 0.3, 0.3, 0.3];  dim_SGD_list = [0.3, 0.3, 0.3, 0.3];
lr_mom_list = [0.3, 0.3, 0.3, 0.3];  mom_list = [0.1, 0.1, 0.1, 0.1];
%待跑：B=100，a1=0.4,a2=0.5,alpha=0.1
for i = 1 : 4
    B = B_list(i);
    E = E_list(i);
