...
B_list = [600];
a1_list = [0.3, 0.7];  % [0.3, 0.7]--> opt: [0.3, 0.7, 0.7]
a2_list = [0.3, 0.7];  % [0.3, 0.7]--> opt: [0.3, 0.7, 0.7]-->[0.2(OK!), 0.7, 0.7]
alpha_list = [0.3, 0.7];  % [0.3, 0.7] --> opt: [0.3, 0.3, 0.3]-->[0.4(OK!), 0.3, 0.3]
acc = [];
cnt = 1;
